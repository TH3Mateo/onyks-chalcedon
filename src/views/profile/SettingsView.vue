...
<template>
    <ProfilePage title="Settings">
        ...
        <onyks-text size="s">
            The program keeps the Altium .DbLib file up to date: with autoupdate on it checks the database
            periodically and adds every new category table (configured like the others) and every new
            supplier column to the file. The connection settings and anything else set in Altium are kept.
            If the file does not exist yet, it is created with the ODBC data source "bloodstone".
